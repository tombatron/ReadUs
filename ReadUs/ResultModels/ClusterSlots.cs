...
public class ClusterSlots
{
    ...
    public override bool Equals(object? obj)
    {
        ...
        {
            if (clusterSlots._slots.Length != _slots.Length) return false;
    ...
    {
        return string.Join(",", string.Join<SlotRange>(",", slots._slots));
    }
    ...
    public class SlotRange : IComparable<SlotRange>
    {
        ...
        {
            return new SlotRange(begin, end);
        }

        public override bool Equals(object? obj)
        {
            if (obj is SlotRange range) return range.Begin == Begin && range.End == End;
